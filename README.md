...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gkqv4em.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gkqv4em.containers.anotherwebservice.com/
...
```
git clone git@github.com:debugtitan/container-gkqv4em.git
cd container-gkqv4em
```
...
```
docker attach container-gkqv4em
```
